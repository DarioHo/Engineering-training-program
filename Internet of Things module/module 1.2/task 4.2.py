...
def draw_bat():
  # set the bat length
  # red is the easy level
  sense.set_pixel(0, bat_pos, 255, 0, 0)      #the pixel of the bat
  sense.set_pixel(0, bat_pos+1, 255, 0, 0)    #the +1 pixel of the bat
  sense.set_pixel(0, bat_pos+2, 255, 0, 0)    #the +2 pixel of the bat
  sense.set_pixel(0, bat_pos-1, 255, 0, 0)    #the -1 pixel of the bat
  sense.set_pixel(0, bat_pos-2, 255, 0, 0)    #the -2 pixel of the bat
